...
public class TripExpensesDTO {
    ...
    public TripExpensesDTO() {
    }

    public TripExpensesDTO(int tripExpId, int tripId, TripExpType tripExpType,
    ...
    public TripExpensesDTO(int tripExpId, int tripId, TripExpType tripExpType,
                           Integer salaryId, double amount, String description,
                           LocalDate date, int createdBy, String createdByUsername) {
        this.tripExpId = tripExpId;
        this.tripId = tripId;
        this.tripExpType = tripExpType;
        this.salaryId = salaryId;
